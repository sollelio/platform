...
// Na ordem final (077) o sinal reserva a data logo a seguir ao aceite;
// do sinal PAGO em diante (contrato/cliente/projecto) pinta sólido —
// o contrato por assinar já é uma data garantida. "perdido" não ocupa
// dias.
