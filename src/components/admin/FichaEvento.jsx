...
export default function FichaEvento({
  ...
  todasFichas = [],
  onFichaAlterada,
  submissionIdFixo = null,
  onContagem,
}) {
  const [submissionIdLocal, setSubmissionIdLocal] = useState("");
  const submissionId = submissionIdFixo ?? submissionIdLocal;
...
function FichaMateriais({
  ...
  useEffect(() => {
    onContagem?.(totalNaFicha);
  }, [totalNaFicha, onContagem]);
