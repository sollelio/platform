...
//
// 104 · A DEGRADAÇÃO GRACIOSA SAIU DAQUI, e foi a última da família.
//
// Havia um `ehEsquemaEmFalta` — seis códigos, tabela, coluna e função —
// que traduzia «a 083 ainda não correu aqui» em null/[] silenciosos.
// Escapou à limpeza da 104 por não usar o `ehFuncaoRpcEmFalta`: era o
// mesmo padrão com outro nome.
//
// Depois da RLS por casa (091) o ramo deixou de dizer a verdade: um
// `42501` não está na lista, e o que era «peça em falta» passou a ser
// política a negar. Pior do que isso: aqui o silêncio custa um AVISO —
// o vazio é indistinguível de «não há disputa», e quem marca um dia já
// disputado deixa de ser avisada.
//
// ⚠ O VAZIO CONTINUA A SER RESPOSTA. `[]` do irmaosDoDia e `null` do
// estadoDoDia são o caso NORMAL — a esmagadora maioria dos dias não tem
// disputa nenhuma. O que saiu foi o vazio a fazer-se passar por
// resposta quando a pergunta nem chegou ao fim.
// ============================================================
...
// conta — ninguém é rival de si mesmo. Null = a RPC respondeu e não há
// estado a dar; um erro LANÇA.
