-- Canonical copy of docs/migracoes/109_a_procura_nao_se_apaga.sql
-- (authored 2026-09-10; historically applied by hand). The SQL below is
-- byte-for-byte the numbered file. supabase/migrations/ is the executable
-- source of truth — see docs/migracoes/README.md.
